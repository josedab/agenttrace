...
func registerPromptsRoutes(public fiber.Router, h *Handlers) {
	...
	public.Get("/prompts/:promptName", h.Prompts.GetPrompt)
	public.Post("/prompts", h.Prompts.CreatePrompt)
	public.Put("/prompts/:promptId", h.Prompts.RequirePromptAccess(), h.Prompts.UpdatePrompt)
	public.Delete("/prompts/:promptId", h.Prompts.RequirePromptAccess(), h.Prompts.DeletePrompt)
	public.Get("/prompts/:promptName/versions", h.Prompts.ListVersions)
	public.Post("/prompts/:promptName/versions", h.Prompts.CreateVersion)
	public.Post("/prompts/:promptName/labels", h.Prompts.SetLabel)
	public.Delete("/prompts/:promptName/labels/:label", h.Prompts.RemoveLabel)
	public.Post("/prompts/:promptName/compile", h.Prompts.CompilePrompt)

	// Datasets
	public.Get("/datasets", h.Datasets.ListDatasets)
	public.Get("/datasets/:datasetId", h.Datasets.RequireDatasetAccess(), h.Datasets.GetDataset)
	public.Post("/datasets", h.Datasets.CreateDataset)
	public.Put("/datasets/:datasetId", h.Datasets.RequireDatasetAccess(), h.Datasets.UpdateDataset)
	public.Delete("/datasets/:datasetId", h.Datasets.RequireDatasetAccess(), h.Datasets.DeleteDataset)
	public.Get("/datasets/:datasetId/items", h.Datasets.RequireDatasetAccess(), h.Datasets.ListItems)
	public.Post("/datasets/:datasetId/items", h.Datasets.RequireDatasetAccess(), h.Datasets.CreateItem)
	public.Put("/datasets/:datasetId/items/:itemId", h.Datasets.RequireDatasetAccess(), h.Datasets.UpdateItem)
	public.Delete("/datasets/:datasetId/items/:itemId", h.Datasets.RequireDatasetAccess(), h.Datasets.DeleteItem)
	public.Get("/datasets/:datasetId/runs", h.Datasets.RequireDatasetAccess(), h.Datasets.ListRuns)
	public.Post("/datasets/:datasetId/runs", h.Datasets.RequireDatasetAccess(), h.Datasets.CreateRun)
	public.Get("/datasets/:datasetId/runs/:runId", h.Datasets.RequireDatasetAccess(), h.Datasets.GetRun)
	public.Post("/datasets/:datasetId/runs/:runId/items", h.Datasets.RequireDatasetAccess(), h.Datasets.AddRunItem)
