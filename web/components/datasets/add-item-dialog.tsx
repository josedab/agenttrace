    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>Add a new test case to the dataset.</DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">Enter JSON or plain text</p>
            </div>
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">The expected result for evaluation</p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">Additional metadata as JSON</p>
            </div>
          </div>
          <DialogFooter>
