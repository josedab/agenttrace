...
export function StreamingDashboard() {
  // TODO: Replace with useStreamingDashboard() hook when available
  const isLoading = false;
  const metrics: DashboardMetrics | null = null;
    ...
    return (
      <div className="text-center py-12 text-muted-foreground">
        ...
        <p className="text-sm mt-2">
          Metrics will appear here when streaming sessions are active
        </p>
      </div>
    );
  }
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-medium truncate">{stream.id}</p>
